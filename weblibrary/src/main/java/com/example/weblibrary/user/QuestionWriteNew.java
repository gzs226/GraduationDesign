...
public class QuestionWriteNew {
     ...
     */
    public void WriteComment(final PostCommentData mPostCommentData, final IWritePost mIWritePost) {
    ...
    private String TransformPost(PostCommentData mPostCommentData) {
        ...
        if (mPostCommentData.getComment_time() != null) {
            postInfor = postInfor + "&" + "comment_time=" + "2017-01-30";//mPostCommentData.getComment_time();
        }
