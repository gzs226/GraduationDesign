...
import com.example.graduationdesign.adapter.NoteBankAdapter;
...
public class NoteBankActivity extends BaseActivity implements CollectionBankListView.OnRefreshListener, CollectionBankListView.OnLoadListener, ListView.OnItemClickListener {
    ...
    private NoteBankAdapter adapter;
    private List<NoteDatas> ListResultdata = new ArrayList<>();
    ...
    private void getData() {
        ...
        List<NoteDatas> data = new ArrayList<>();
    ...
    private void ToQuestionDetail(int position,int QuestionId) {
        ...
        Intent intent = new Intent(NoteBankActivity.this, QuestionDetailedActivity.class);
