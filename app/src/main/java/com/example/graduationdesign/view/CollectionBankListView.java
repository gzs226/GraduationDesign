...
public class CollectionBankListView extends ListView implements OnScrollListener {
	...
	public CollectionBankListView(Context context) {
		super(context);
		initView(context);
	}

	public CollectionBankListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public CollectionBankListView(Context context, AttributeSet attrs, int defStyle) {
