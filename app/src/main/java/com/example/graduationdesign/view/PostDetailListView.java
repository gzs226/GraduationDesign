...
public class PostDetailListView extends ListView implements OnScrollListener {
	...
	private PostSortItemView mPostSortItemView;
	private SortItemOnClickListener mSortItemOnClickListener;

	private ImageView imageviewPostTitleIcon;
	private TextView textviewPostTitle;
	private TextView textviewPostTitleDetail;
	...
	public PostDetailListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public PostDetailListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		...
		mainPost = inflater.inflate(R.layout.item_main_post, null);
		mPostSortItemView = (PostSortItemView)mainPost.findViewById(R.id.postsort_select_sort);
		mPostSortItemView.setSortItemOnClickListener(new MySortItemOnClickListener());
		imageviewPostTitleIcon = (ImageView)mainPost.findViewById(R.id.imageview_post_titleicon);
		textviewPostTitle = (TextView)mainPost.findViewById(R.id.textview_post_title);
		textviewPostTitleDetail = (TextView)mainPost.findViewById(R.id.textview_post_titledetail);
	...
	public void setInitMainView(int resId,String title,String titleDetail){
		imageviewPostTitleIcon.setImageResource(resId);
		textviewPostTitle.setText(""+title);
		textviewPostTitleDetail.setText(""+titleDetail);
	}
	...
	class MySortItemOnClickListener implements PostSortItemView.SortItemOnClickListener{

		@Override
		public void SortItemChanges(int modelId) {
			mSortItemOnClickListener.SortItemChanges(modelId);
		}
	}
