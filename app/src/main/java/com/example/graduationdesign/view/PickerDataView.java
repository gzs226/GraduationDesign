...
public class PickerDataView extends View {
    /**
    ...
    public PickerDataView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.PickerDataView);
        loop = typedArray.getBoolean(R.styleable.PickerDataView_isLoop, loop);
        typedArray.recycle();
        init();
    }
