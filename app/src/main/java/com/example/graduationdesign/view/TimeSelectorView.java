...
public class TimeSelectorView {
    ...
    private PickerDataView year_pv;
    private PickerDataView month_pv;
    private PickerDataView day_pv;
    private PickerDataView hour_pv;
    private PickerDataView minute_pv;
    ...
    public TimeSelectorView(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    public TimeSelectorView(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
    ...
    private void initView() {
        year_pv = (PickerDataView) seletorDialog.findViewById(R.id.year_pv);
        month_pv = (PickerDataView) seletorDialog.findViewById(R.id.month_pv);
        day_pv = (PickerDataView) seletorDialog.findViewById(R.id.day_pv);
        hour_pv = (PickerDataView) seletorDialog.findViewById(R.id.hour_pv);
        minute_pv = (PickerDataView) seletorDialog.findViewById(R.id.minute_pv);
    ...
    private boolean excuteWorkTime() {
        boolean res = true;
        if (!DateUtil.isEmpty(workStart_str) && !DateUtil.isEmpty(workEnd_str)) {
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new PickerDataView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new PickerDataView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new PickerDataView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new PickerDataView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new PickerDataView.onSelectListener() {
            @Override
            public void onSelect(String text) {
